...
<svg class="lm" viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  const HDO = {
    ...
    projGrid:
      '\n      <article class="proj feat reveal" data-hover data-modal-title="LE LANCEMENT" data-modal-text="Tout a commencé autour d’une table. || Pas simplement pour partager un repas, mais pour donner vie à une vision. || Le lancement de Hors d’Œuvre n’avait pas vocation à présenter un nouveau traiteur. Il s’agissait de poser les bases d’une manière différente de penser l’événementiel culinaire. Une cuisine qui dépasse l’assiette. Une cuisine qui dialogue avec un lieu, une ambiance, une intention. || Chaque détail avait été pensé pour raconter cette histoire : les compositions, les couleurs, les matières, le rythme du service, la façon dont les invités se déplaçaient et se rencontraient. || Parce qu’au fond, nous ne créons pas seulement des plats. || Nous créons des moments qui rassemblent, suscitent des échanges et laissent une empreinte bien après la dernière bouchée.">\n        <div class="media"><div class="ph" data-ph="[PROJET_1_IMAGE] · soirée de lancement — Cassis"></div></div>\n        <div class="scrim"></div>\n        <div class="meta"><span class="tag">Soirée de lancement</span><h3>Lancement<br>Ça Parle × Hors d\'Œuvre</h3><div class="loc">Cassis — soirée de lancement des deux marques.</div></div>\n      </article>\n      <article class="proj c7 reveal" data-hover data-modal-title="LA PLAGE" data-modal-text="La plage n’était pas un décor. || Elle faisait partie du récit. || Le vent, le sable, la lumière changeante, l’horizon. Tout ce que certains considèrent comme des contraintes devient pour nous une matière de création. || Nous aimons les lieux vivants. Ceux qui possèdent déjà une énergie, une atmosphère, une personnalité. || La cuisine s’y adapte naturellement. Elle dialogue avec son environnement, joue avec les contrastes, accompagne le moment plutôt que de l’imposer. || Car une expérience réussie ne se construit pas uniquement autour de ce que l’on mange. || Elle naît d’un ensemble : un paysage, une émotion, une rencontre, une sensation. || Et parfois, il suffit d’un coucher de soleil, d’une table dressée face à la mer et de quelques assiettes partagées pour créer un souvenir durable.">\n        <div class="media"><div class="ph"><img src="assets/projet-plage.jpg" alt="Scénographie de plage" style="object-position:center 28%"></div></div>\n        <div class="scrim"></div>\n        <div class="meta"><span class="tag">Scénographie</span><h3>Scénographie de plage</h3><div class="loc">Marseille — sur la plage.</div></div>\n      </article>\n      <article class="proj c5 reveal" data-hover data-modal-title="LA LAVERIE" data-modal-text="Une laverie n’a rien d’un lieu événementiel. || C’est précisément ce qui nous intéressait. || Chez Hors d’Œuvre, nous sommes convaincus que le potentiel d’un lieu ne dépend pas de son prestige mais du regard que l’on porte sur lui. || Une laverie possède déjà tout ce qu’il faut : une architecture, des couleurs, des volumes, des usages, une identité forte. Il suffit parfois de déplacer les codes pour révéler quelque chose de nouveau. || En installant la cuisine dans cet univers inattendu, nous ne cherchions pas à transformer le lieu. || Nous cherchions à montrer qu’une expérience peut naître partout. || Que la créativité n’a pas besoin d’un cadre exceptionnel pour exister. || Et qu’au fond, les souvenirs les plus marquants sont souvent ceux qui apparaissent là où personne ne les attendait. || Parce qu’un lieu reste un lieu. || Jusqu’à ce qu’Hors d’Œuvre en fasse autre chose">\n        <div class="media"><div class="ph" data-ph="[PROJET_3_IMAGE]"></div></div>\n        <div class="scrim"></div>\n        <div class="meta"><span class="tag">Éditorial</span><h3>Séance éditoriale</h3><div class="loc">Dans une laverie automatique.</div></div>\n      </article>\n    ',
