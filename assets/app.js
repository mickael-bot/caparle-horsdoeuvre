...
<svg class="lm" viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  function initAgenceScroll() {
    document.addEventListener("click", (e) => {
      ...
      if (!a) return;
      e.preventDefault();
      // Les deux marques utilisent la maquette : « L'agence » / « Le studio » va à la présentation (.dk-intro)
      const tgt = document.querySelector(".dk-intro");
  ...
  const HDO = {
    ...
    dkIntro: '<p>Un traiteur nouvelle génération, pensé comme un studio culinaire événementiel. Des tables, des expériences food et des moments conçus comme des concepts.</p><p>Ici, la cuisine est un terrain de création.</p><p>Instinct, précision, liberté. Le goût devient un langage, la table un dispositif, chaque plat une intention. On ne sert pas simplement à manger : on crée une impulsion, un moment qui capte l’attention et déclenche l’envie.</p><p>Hors d’Œuvre évoque ce qui précède et ce qui ouvre. Le premier geste, la première bouchée, le point de départ. Ce moment où tout commence autour de la table. Une cuisine qui lance l’expérience, qui rassemble et qui marque les esprits.</p><div class="dk-end">On crée une impulsion.</div>',
    ...
    dkSlideshow: '<img src="assets/projet-event-hdo.jpg" alt=""><img src="assets/projet-plage-hdo.jpg" alt=""><img src="assets/projet-laverie-hdo.jpg" alt=""><div class="dk-cap dk-cap-1"><span class="t">Soirée de lancement</span><h4>Lancement Ça Parle × Hors d’Œuvre</h4></div><div class="dk-cap dk-cap-2"><span class="t">Scénographie</span><h4>Scénographie de plage</h4></div><div class="dk-cap dk-cap-3"><span class="t">Éditorial</span><h4>La laverie</h4></div><div class="dk-dots"><span></span><span></span><span></span></div>',
    dkMetiers: '<li><span>01</span>Nos pièces salées froides<div class="dk-mbubble"><b>Nos pièces salées froides</b><span class="dk-mq">« [accroche à définir] »</span>[Description à compléter.]</div></li><li><span>02</span>Nos pièces salées chaudes<div class="dk-mbubble"><b>Nos pièces salées chaudes</b><span class="dk-mq">« [accroche à définir] »</span>[Description à compléter.]</div></li><li><span>03</span>Nos pièces sucrées<div class="dk-mbubble"><b>Nos pièces sucrées</b><span class="dk-mq">« [accroche à définir] »</span>[Description à compléter.]</div></li><li><span>04</span>Nos animations culinaires<div class="dk-mbubble"><b>Nos animations culinaires</b><span class="dk-mq">« [accroche à définir] »</span>[Description à compléter.]</div></li>',
    dkRefsCards: '<div class="dk-card b1"><div class="q">"Le banquet est tout simplement incroyable. Un festin généreux, raffiné, pensé dans le moindre détail. Dès la première bouchée, l’effet est immédiat : impressionnant."</div><div class="who"><b>(nom)</b><small>(entreprise)</small></div></div><div class="dk-card b2"><div class="q">"Vraiment, le buffet est ouf. Gourmand, audacieux, sans la moindre fausse note, la preuve que la food peut être un vrai spectacle. Inimitable."</div><div class="who"><b>(nom)</b><small>(entreprise)</small></div></div><div class="dk-card b3"><div class="q">"On vient découvrir Hors d’Œuvre pour la partie food, voir ce que ça donne… et on repart conquis. Un savoir-faire qui se goûte autant qu’il se montre. Magnifique."</div><div class="who"><b>(nom)</b><small>(entreprise)</small></div></div>',
  };
