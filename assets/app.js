...
<svg class="lm" viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  const HDO = {
    ...
    projGrid:
      '\n      <article class="proj feat reveal" data-hover>\n        <div class="media"><div class="ph" data-ph="[PROJET_1_IMAGE] · dîner signature"></div></div>\n        <div class="scrim"></div>\n        <div class="meta"><span class="tag">Brand Event — Signature</span><h3>Dîner signature<br>sur-mesure</h3><div class="loc">Une scénographie culinaire complète : volumes, matières, temporalité — la table devient manifeste.</div></div>\n      </article>\n      <article class="proj c7 reveal" data-hover>\n        <div class="media"><div class="ph" data-ph="[PROJET_2_IMAGE]"></div></div>\n        <div class="scrim"></div>\n        <div class="meta"><span class="tag">Cocktail dînatoire</span><h3>[PROJET_2_TITRE]</h3><div class="loc">[PROJET_2_LIEU]</div></div>\n      </article>\n      <article class="proj c5 reveal" data-hover>\n        <div class="media"><div class="ph" data-ph="[PROJET_3_IMAGE]"></div></div>\n        <div class="scrim"></div>\n        <div class="meta"><span class="tag">Art de la table</span><h3>[PROJET_3_TITRE]</h3><div class="loc">[PROJET_3_LIEU]</div></div>\n      </article>\n      <article class="proj c4 reveal" data-hover>\n        <div class="media"><div class="ph" data-ph="[PROJET_4_IMAGE]"></div></div>\n        <div class="scrim"></div>\n        <div class="meta"><span class="tag">Congrès</span><h3>[PROJET_4_TITRE]</h3><div class="loc">[PROJET_4_LIEU]</div></div>\n      </article>\n      <article class="proj c4 reveal" data-hover>\n        <div class="media"><div class="ph" data-ph="[PROJET_5_IMAGE]"></div></div>\n        <div class="scrim"></div>\n        <div class="meta"><span class="tag">Dîner assis</span><h3>[PROJET_5_TITRE]</h3><div class="loc">[PROJET_5_LIEU]</div></div>\n      </article>\n      <article class="proj c4 reveal" data-hover>\n        <div class="media"><div class="ph" data-ph="[PROJET_6_IMAGE]"></div></div>\n        <div class="scrim"></div>\n        <div class="meta"><span class="tag">Buffet signature</span><h3>[PROJET_6_TITRE]</h3><div class="loc">[PROJET_6_LIEU]</div></div>\n      </article>\n    ',
    ...
    footerTag: "C'est déjà le plat principal. Toujours avec un temps d'avance. Marseille et partout ailleurs.",
  };
  ...
  function applyBrand(brand) {
    ...
    const logoSrc = brand === "hors-doeuvre" ? "assets/logo-horsdoeuvre.png" : "assets/logo-caparle.png";
    document.querySelectorAll(".nav-logo-img, .hero-logo-img").forEach((img) => (img.src = logoSrc));
